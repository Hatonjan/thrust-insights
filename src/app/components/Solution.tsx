        ...
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[2fr_0.125fr_2fr] gap-4 mb-12 items-center">
            <figure>
              ...
              className="relative rounded-sm w-full h-95"
              />
            </figure>
            <h2 className="flex items-center justify-center text-4xl font-bold text-[#FF5C00]">
              →
            </h2>
            <figure>
              <img 
        ...
        <div className="relative mt-16">
          ...
          <div className="relative">
            <img
              ...
              className="w-full h-full rounded-sm shadow-2xl border border-[#94A3B8]/20"
            />
